...
<img src="https://skillicons.dev/icons?i=c,cpp,python,go,rust,ts,js,html,css,wasm,react,tailwindcss,nextjs,flask,vue,fastapi,bootstrap,jquery,pytorch,aws,cloudflare,nginx,neovim,vscode,latex,markdown,powershell,discordbots,git,linux" />
